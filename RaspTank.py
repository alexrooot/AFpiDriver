...
def instruction():
    ...
    while 1:
        ...
        instruction_3 = 'I: Look up   K: Look down  '
        instructions.append(instruction_3)
        instruction_4 = 'Please use your keyboard'
        instructions.append(instruction_4)
        instruction_5 = ' Dont drive on uneven floors'
        instructions.append(instruction_5)
        instruction_6 = ' Dont force the vehicle to move if its stuck!'
        instructions.append(instruction_6)
        instruction_7 = 'Keep the gear clean of debri at all times'
...
def loop():                      #GUI
    ...
    while True:
        ...
        root.title('AF Driver')      #Main window title
        ...
        Btn_Cleft = tk.Button(root, width=8, text='pending',fg=color_text,bg=color_btn,relief='ridge')
        Btn_Cright = tk.Button(root, width=8, text='pending',fg=color_text,bg=color_btn,relief='ridge')
